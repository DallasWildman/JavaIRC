...
/**
 * This class is modified from IRClib to listen incoming events
 * like messages.
 * 
...
public interface IRCEventListener extends EventListener, IRCNumericReplies {
...
// ------------------------------
	 ...
	 *                    (passive).
	 */
	public void onInvite(String chan, IRCUserInfo user, String passiveNick);
...
// ------------------------------
	 ...
	 *            no message was set.
	 */
	public void onKick(String chan, IRCUserInfo user, String passiveNick, String msg);
