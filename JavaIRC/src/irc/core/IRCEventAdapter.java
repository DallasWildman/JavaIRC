...
/*
 * This class is modified from IRClib as a general implementation
 * of IRCEventListener interface.
 * 
 * Detailed information for IRClib can be found at:
 * http://moepii.sourceforge.net/
 */
public class IRCEventAdapter {
	/** 
...
// ------------------------------
	 ...
	 *            no message was set.
	 */
	public void onKick(String chan, IRCUserInfo user, String passiveNick, 
			String msg) {
		// nothing
	}
