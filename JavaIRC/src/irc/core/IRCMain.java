 ...
 */
public class IRCMain extends Thread {
	...
	/**
	 * This is like a UNIX-runlevel. Its value indicates the level of the <code>IRCMain</code> object. 
	 * <code>0</code> means that the object has not yet been connected;
	 * <code>1</code> means that it's connected but not registered;
	 * <code>2</code> means that it's connected and registered, but still waiting to receive the nickname the first time;
	 * <code>3</code> means that it's connected and registered;
	 * <code>-1</code> means that it was connected but is disconnected. 
...
// ------------------------------
	 ...
	 * @see #connect()
	 */
	public IRCMain(String host, int[] ports, String pass, String nick, 
...
// ------------------------------
	 ...
	 * @see #connect()
	 */
	public IRCMain(String host, int portMin, int portMax, String pass, 
